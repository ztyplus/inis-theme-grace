<template>
  ...
  <div class="message-pages p-2 mt-2 text-left" v-for="(item,index) in commentList" :key="index">
    <div class="msg-head flex">
      ...
      <div class="info pl-1 w-100">
        <div>
          ...
          <span style="display:inline-block;vertical-align: text-top;" class="item-text h-40">{{item.create_time}}</span>
        </div>
      </div>
    </div>
